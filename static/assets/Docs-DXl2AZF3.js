import{d as l,c as r,a as o,F as u,r as x,x as d,i,e as s,n as c,t as p}from"./index-5BofdoOB.js";const m={class:"space-y-6"},b={class:"rounded-3xl border border-border bg-card p-6"},f={class:"mt-6 flex rounded-full border border-border bg-muted/30 p-1 text-xs"},q=["onClick"],v={key:0,class:"mt-6 space-y-4 text-sm text-foreground"},g={key:1,class:"mt-6 space-y-3 text-xs text-muted-foreground leading-relaxed"},k=l({__name:"Docs",setup(_){const a=i("api"),n=[{id:"api",label:"API 文档"},{id:"disclaimer",label:"使用声明"}];return(y,e)=>(s(),r("div",m,[o("section",b,[e[2]||(e[2]=o("div",{class:"space-y-1"},[o("p",{class:"text-base font-semibold text-foreground"},"帮助中心"),o("p",{class:"text-xs text-muted-foreground"},"Exa API 池化与常见问题")],-1)),o("div",f,[(s(),r(u,null,x(n,t=>o("button",{key:t.id,class:c(["flex-1 rounded-full px-4 py-2 font-medium transition-colors",a.value===t.id?"bg-foreground text-background":"text-muted-foreground hover:text-foreground"]),onClick:h=>a.value=t.id},p(t.label),11,q)),64))]),a.value==="api"?(s(),r("div",v,[...e[0]||(e[0]=[d(`<div class="space-y-2"><p class="font-semibold">\`/search\`（推荐入口）</p><pre class="overflow-x-auto whitespace-pre-wrap rounded-2xl border border-border bg-card px-4 py-3 text-xs font-mono scrollbar-slim">curl -X POST &quot;http://localhost:7860/search&quot; \\
