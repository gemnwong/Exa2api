...
SERVICES = {
    ...
    "exa-search": {"name": "Exa Search", "heartbeats": deque(maxlen=MAX_HEARTBEATS)},
    "exa-contents": {"name": "Exa Contents", "heartbeats": deque(maxlen=MAX_HEARTBEATS)},
    "exa-answer": {"name": "Exa Answer", "heartbeats": deque(maxlen=MAX_HEARTBEATS)},
    "exa-find-similar": {"name": "Exa FindSimilar", "heartbeats": deque(maxlen=MAX_HEARTBEATS)},
    "exa-research": {"name": "Exa Research", "heartbeats": deque(maxlen=MAX_HEARTBEATS)},
}
